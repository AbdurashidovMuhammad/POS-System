        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockQuantity = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_UnitPrice_Positive", "\"UnitPrice\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Sales_TotalAmount_Positive", "\"TotalAmount\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SaleItems_UnitPrice_Positive", "\"UnitPrice\" > 0");
                    table.ForeignKey(
