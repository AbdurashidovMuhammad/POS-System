...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260227032638_AddPermissionSystem")]
            ...
            modelBuilder.Entity("Core.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Action = "Read",
                            DisplayName = "Mahsulotlarni ko'rish",
                            Section = "Products"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = 3,
                            Action = "Update",
                            DisplayName = "Mahsulotni tahrirlash",
                            Section = "Products"
                        },
                        new
                        {
                            Id = 4,
                            Action = "Delete",
                            DisplayName = "Mahsulotni o'chirish",
                            Section = "Products"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = 6,
                            Action = "Read",
                            DisplayName = "Kategoriyalarni ko'rish",
                            Section = "Categories"
                        },
                        new
                        {
                            Id = 7,
                            Action = "Create",
                            DisplayName = "Kategoriya qo'shish",
                            Section = "Categories"
                        },
                        new
                        {
                            Id = 8,
                            Action = "Update",
                            DisplayName = "Kategoriyani tahrirlash",
                            Section = "Categories"
                        },
                        new
                        {
                            Id = 9,
                            Action = "Delete",
                            DisplayName = "Kategoriyani o'chirish",
                            Section = "Categories"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = 11,
                            Action = "ViewHistory",
                            DisplayName = "Sotuvlar tarixini ko'rish",
                            Section = "Sales"
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.ProductBatch", b =>
                {
                    ...
                    b.HasIndex("ProductId", "RemainingQuantity", "ReceivedAt")
            ...
            modelBuilder.Entity("Core.Entities.StockMovement", b =>
                {
                    ...
                    b.HasIndex("UserId", "MovementType", "MovementDate")
