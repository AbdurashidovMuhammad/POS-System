...
public interface IReportService
{
    ...
    Task<OrdersReportDto> GetOrdersReportAsync(DateTime from, DateTime to, PaginationParams pagination, int? userId = null);
    ...
    Task<byte[]> ExportOrdersReportAsync(DateTime from, DateTime to, int? userId = null);
